...
export default function Contact() {
  ...
  const phoneDisplay = "+44 7976 286 141";
  const phoneHref = "tel:+447976286141";
  const whatsappHref = "https://wa.me/447976286141";
            ...
            <div className="row gy-4">
              ...
              <div className="col-lg-4">
                <div className="roof-contact-card">
                  ...
                  <a
                    href="mailto:info@kingsheathroofing.co.uk"
            ...
            <div className="row gy-4 align-items-stretch">
              <div className="col-lg-6">
                <div className="roof-map-wrap">
                  <iframe
                    src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2432.4522403683272!2d-1.9066266231131441!3d52.43472204253944!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x4870bd49a0400a21%3A0xa5f5c33f8e86b7d3!2sMark%20The%20Roof%20in%20Kings%20Heath%20Birmingham%20UK!5e0!3m2!1sen!2s!4v1778664186703!5m2!1sen!2s"
                    title="Kings Heath Birmingham Roofing Map"
                    loading="lazy"
                    allowFullScreen
                                ...
                                {filteredServices.length > 0 ? (
                                  filteredServices.map((item) => (
                                    <button
                                      type="button"
                                      key={item}
                                      className={`roof-service-list-item ${selected.includes(item)
                                          ? "selected"
                                          : ""
                                        }`}
          ...
          <div className="container">
            <div className="row gy-4">
              ...
              <InfoItem
                icon={<GeoAltFill />}
                title="Location"
                text="20 Uffculme Rd,Birmingham"
              />
